...
export const createAcademicEventAndPublish = async (name, startingDate, endDate, groupName, periodicity, description, type, startTime, endTime, subjectId) => {
    // Primero, creamos el evento académico
    const { data: academicEvent, error: academicEventError } = await createAcademicEvent(name, startingDate, endDate, groupName, periodicity, description, type, startTime, endTime, subjectId);
...
export const createAcademicEvent = async (name, startingDate, endDate, groupName, periodicity, description,type, startTime, endTime, subjectId) => {
